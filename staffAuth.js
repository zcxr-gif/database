 ...
 * CAN write `document.cookie = 'staff_token=…; domain=<ours>'` and have that value
...
const LEGACY_COOKIE_NAME = 'staff_token';
const COOKIE_NAME = SECURE_COOKIES ? '__Host-staff_token' : LEGACY_COOKIE_NAME;
const TOKEN_TTL = '7d';
